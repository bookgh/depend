...
# /usr/local/bin/tsdb tsd --port=14242 --staticroot=/usr/local/share/opentsdb/static --cachedir=/tmp --auto-metric
/usr/local/bin/tsdb tsd --config=/etc/opentsdb/opentsdb.conf
